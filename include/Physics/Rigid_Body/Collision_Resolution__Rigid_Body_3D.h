...
namespace LMD
{
    ...
    private:
        ...
        void M_apply_friction(Physics_Module__Rigid_Body* _rb, const glm::vec3& _normal, const glm::vec3& _radius_vector, float _normal_velocity, glm::vec3& _new_velocity, glm::vec3& _new_angular_velocity);
