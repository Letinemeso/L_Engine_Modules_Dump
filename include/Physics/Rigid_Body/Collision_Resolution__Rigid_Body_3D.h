...
namespace LMD
{
    ...
    private:
        ...
        float m_ws_local_point_distance_tolerance = 0.15f;
    ...
    private:
        ...
        using Warm_Starting_Data_Map = LDS::Map<LST::UInt128, LDS::Vector<Warm_Starting_Data>>;
        Warm_Starting_Data_Map m_previous_intersections;
        Warm_Starting_Data_Map m_current_intersections;

        struct Prep_Data
        {
            LDS::Vector<Warm_Starting_Data*> old_ws_data;
            LDS::Vector<Warm_Starting_Data*> new_ws_data;
    ...
    private:
        ...
        bool M_ws_data_compatible(const Warm_Starting_Data& _data, const glm::vec3& _normal, const glm::vec3& _local_point_0, const glm::vec3& _local_point_1) const;
        glm::vec3 M_calculate_local_contact_point(const LPhys::Physics_Module* _pm, const glm::vec3& _contact_point) const;
        Warm_Starting_Data* M_find_ws_data(const LPhys::Physics_Module* _pm_0, const LPhys::Physics_Module* _pm_1,
