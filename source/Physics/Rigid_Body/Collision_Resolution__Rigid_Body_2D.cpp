#include <Physics/Rigid_Body/Collision_Resolution__Rigid_Body_2D.h>
...
bool Collision_Resolution__Rigid_Body_2D::resolve(const LPhys::Intersection_Data &_id, float _dt)
{
    ...
    const glm::vec3& A_center_of_mass = pm1->center_of_mass();
    const glm::vec3& B_center_of_mass = pm2->center_of_mass();
